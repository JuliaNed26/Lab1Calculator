...
public partial class LabCalculatorBaseListener : ILabCalculatorListener {
	...
	/// <summary>
	/// Enter a parse tree produced by the <c>ExpSignExpr</c>
	/// labeled alternative in <see cref="LabCalculatorParser.expression"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterExpSignExpr([NotNull] LabCalculatorParser.ExpSignExprContext context) { }
	/// <summary>
	/// Exit a parse tree produced by the <c>ExpSignExpr</c>
	/// labeled alternative in <see cref="LabCalculatorParser.expression"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitExpSignExpr([NotNull] LabCalculatorParser.ExpSignExprContext context) { }
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterMinExpr([NotNull] LabCalculatorParser.MinExprContext context) { }
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitMinExpr([NotNull] LabCalculatorParser.MinExprContext context) { }
