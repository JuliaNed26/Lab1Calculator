...
public partial class LabCalculatorParser : Parser {
	public const int
		...
		ADD=8, LPAREN=9, RPAREN=10, INC=11, DEC=12, MAX=13, MIN=14, COMMA=15, 
		WS=16;
	public const int
	...
	private static readonly string[] _SymbolicNames = {
		...
		"SUBTRACT", "ADD", "LPAREN", "RPAREN", "INC", "DEC", "MAX", "MIN", "COMMA", 
		"WS"
	};
	...
	public partial class ExpSignExprContext : ExpressionContext {
		public IToken operatorToken;
		public ExpressionContext expression() {
			return GetRuleContext<ExpressionContext>(0);
		}
		public ITerminalNode ADD() { return GetToken(LabCalculatorParser.ADD, 0); }
		public ITerminalNode SUBTRACT() { return GetToken(LabCalculatorParser.SUBTRACT, 0); }
		public ExpSignExprContext(ExpressionContext context) { CopyFrom(context); }
		public override void EnterRule(IParseTreeListener listener) {
			ILabCalculatorListener typedListener = listener as ILabCalculatorListener;
			if (typedListener != null) typedListener.EnterExpSignExpr(this);
		}
		public override void ExitRule(IParseTreeListener listener) {
			ILabCalculatorListener typedListener = listener as ILabCalculatorListener;
			if (typedListener != null) typedListener.ExitExpSignExpr(this);
		}
		public override TResult Accept<TResult>(IParseTreeVisitor<TResult> visitor) {
			ILabCalculatorVisitor<TResult> typedVisitor = visitor as ILabCalculatorVisitor<TResult>;
			if (typedVisitor != null) return typedVisitor.VisitExpSignExpr(this);
			else return visitor.VisitChildren(this);
		}
	}
	...
	private ExpressionContext expression(int _p) {
		...
		try {
			...
			case ADD:
				{
				_localctx = new ExpSignExprContext(_localctx);
				_ctx = _localctx;
				_prevctx = _localctx;
				State = 12;
				((ExpSignExprContext)_localctx).operatorToken = _input.Lt(1);
				_la = _input.La(1);
				if ( !(_la==SUBTRACT || _la==ADD) ) {
					((ExpSignExprContext)_localctx).operatorToken = _errHandler.RecoverInline(this);
				} else {
			...
			case MAX:
				...
				State = 20; ((MaxExprContext)_localctx).exp1 = expression(0);
				State = 21; Match(COMMA);
				State = 22; ((MaxExprContext)_localctx).exp2 = expression(0);
			...
			case MIN:
				...
				State = 27; ((MinExprContext)_localctx).exp1 = expression(0);
				State = 28; Match(COMMA);
				State = 29; ((MinExprContext)_localctx).exp2 = expression(0);
	...
	public static readonly string _serializedATN =
		"\x3\xAF6F\x8320\x479D\xB75C\x4880\x1605\x191C\xAB37\x3\x12\x35\x4\x2\t"+
		...
		"\xE\x3\x33\v\x3\x3\x3\x2\x2\x3\x4\x4\x2\x2\x4\x2\x2\x4\x3\x2\t\n\x3\x2"+
		"\a\b<\x2\x6\x3\x2\x2\x2\x4$\x3\x2\x2\x2\x6\a\x5\x4\x3\x2\a\b\a\x2\x2\x3"+
		"\b\x3\x3\x2\x2\x2\t\n\b\x3\x1\x2\n\v\a\v\x2\x2\v\f\x5\x4\x3\x2\f\r\a\f"+
		"\x2\x2\r%\x3\x2\x2\x2\xE\xF\t\x2\x2\x2\xF%\x5\x4\x3\t\x10\x11\a\r\x2\x2"+
		"\x11%\x5\x4\x3\b\x12\x13\a\xE\x2\x2\x13%\x5\x4\x3\a\x14\x15\a\xF\x2\x2"+
		"\x15\x16\a\v\x2\x2\x16\x17\x5\x4\x3\x2\x17\x18\a\x11\x2\x2\x18\x19\x5"+
		"\x4\x3\x2\x19\x1A\a\f\x2\x2\x1A%\x3\x2\x2\x2\x1B\x1C\a\x10\x2\x2\x1C\x1D"+
		"\a\v\x2\x2\x1D\x1E\x5\x4\x3\x2\x1E\x1F\a\x11\x2\x2\x1F \x5\x4\x3\x2 !"+
		"\a\f\x2\x2!%\x3\x2\x2\x2\"%\a\x3\x2\x2#%\a\x4\x2\x2$\t\x3\x2\x2\x2$\xE"+
		"\x3\x2\x2\x2$\x10\x3\x2\x2\x2$\x12\x3\x2\x2\x2$\x14\x3\x2\x2\x2$\x1B\x3"+
		"\x2\x2\x2$\"\x3\x2\x2\x2$#\x3\x2\x2\x2%\x31\x3\x2\x2\x2&\'\f\f\x2\x2\'"+
		"(\a\x6\x2\x2(\x30\x5\x4\x3\r)*\f\v\x2\x2*+\t\x3\x2\x2+\x30\x5\x4\x3\f"+
		",-\f\n\x2\x2-.\t\x2\x2\x2.\x30\x5\x4\x3\v/&\x3\x2\x2\x2/)\x3\x2\x2\x2"+
		"/,\x3\x2\x2\x2\x30\x33\x3\x2\x2\x2\x31/\x3\x2\x2\x2\x31\x32\x3\x2\x2\x2"+
		"\x32\x5\x3\x2\x2\x2\x33\x31\x3\x2\x2\x2\x5$/\x31";
